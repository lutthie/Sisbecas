...
<body>
  ...
  <div class="container-all">
    <img src="img/whops.jpg" alt="">
    <h1 class="title">Oh no! Ha ocurrido un error</h1>       
    <p>Ha ocurrido un error inesperado, por favor intenta recargar la página o intentalo mas tarde.</p>
